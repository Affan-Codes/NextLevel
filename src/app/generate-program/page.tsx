...
const GenerateProgramPage = () => {
  ...
  // NAVIGATE USER TO PROFILE PAGE AFTER THE CALL END
  useEffect(() => {
    if (callEnded) {
  ...
  useEffect(() => {
    ...
    // Clean event listeners on unmount
    return () => {
      vapi
            ...
            <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
              ...
              <div className={ `absolute inset-0 ${isSpeaking ? "opacity-30" : "opacity-0"} transition-opacity duration-300` }>
                ...
                <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex justify-center items-center h-20">
                  { [...Array(5)].map((_, i) => (
                    <div className={ `mx-1 h-16 w-1 bg-primary rounded-full ${isSpeaking ? "animate-sound-wave" : ""}` } key={ i } style={ {
              ...
              <h2 className="text-xl font-bold text-foreground">NextLevel AI</h2>
