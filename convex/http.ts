    ...
    try {
          ...
          results: [
            {
              ...
              result:
                "Fitness plan successfully created! Your personalized program has been saved to your profile.",
            },
          ],
        }),
        {
      ...
      return new Response(
        JSON.stringify({
          results: [
            {
              toolCallId: payload?.message?.toolCalls?.[0]?.id || "unknown",
              result:
                "I apologize, but there was an error creating your fitness plan. Please try again.",
            },
          ],
        }),
        {
